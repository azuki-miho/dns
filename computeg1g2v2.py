...
g10a = numpy.array(g10)
BJe1a = numpy.array(BJe1[0])
a,b,r = linematch(g10a,BJe1a)
xf = numpy.linspace(-0.01,0.01,100)
yf = a*xf+b
plt.plot(xf,xf,color="red")
plt.plot(xf,yf,color="green")
plt.scatter(g10,BJe1[0],marker='+',color='g')
plt.title('BJ Gaussian e1 y=%fx+%f'%(a,b))
plt.show()
