...
a,b,r=linematch(e20,gal1e2arr)
fig1.set_title("the function is y = %f x + %f and r = %f"%(a,b,r))
fig1.scatter(e20,gal1e2arr)
...
a,b,r=linematch(e20,gal4e2arr)
fig4.set_title("the function is y = %f x + %f and r = %f"%(a,b,r))
fig4.scatter(e20,gal4e2arr)
yf = a*xf + b
