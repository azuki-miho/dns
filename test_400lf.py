...
a,b,r=linematch(gal1e1arr,gal1wne1)
fig1.set_title("the function is y = %f x + %f and r = %f"%(a,b,r))
fig1.scatter(gal1e1arr,gal1wne1)
xf = np.linspace(-0.5,0,1000)
yf = a*xf + b
...
a,b,r=linematch(gal2e1arr,gal2wne1)
fig2.set_title("the function is y = %f x + %f and r = %f"%(a,b,r))
fig2.scatter(gal2e1arr,gal2wne1)
yf = a*xf + b
...
a,b,r=linematch(gal3e1arr,gal3wne1)
fig3.set_title("the function is y = %f x + %f and r = %f"%(a,b,r))
fig3.scatter(gal3e1arr,gal3wne1)
yf = a*xf + b
...
a,b,r=linematch(gal4e1arr,gal4wne1)
fig4.set_title("the function is y = %f x + %f and r = %f"%(a,b,r))
fig4.scatter(gal4e1arr,gal4wne1)
yf = a*xf + b
